...
from core.serializers.question_option_serializer import QuestionOptionCRUDSerializer
...
class TestQuestionOptionCRUDSerializer:
    def test_contains_expected_fields(
        self,
        question_option: QuestionOption,
    ) -> None:
        serializer = QuestionOptionCRUDSerializer(question_option)
        expected_fields = {
            'public_id',
            'content',
            'is_answer',
    ...
    def test_read_only_fields(self) -> None:
        meta = QuestionOptionCRUDSerializer.Meta
    ...
    def test_valid_data(
        ...
        data = {'content': 'Test option', 'is_answer': True}
        serializer = QuestionOptionCRUDSerializer(data=data)
